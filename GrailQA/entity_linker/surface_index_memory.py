...
from entity_linker import aaqu_entity_linker
from entity_linker.aaqu_util import normalize_entity_name
import collections
...
class EntitySurfaceIndexMemory(object):
    ...
    def _string_to_entity(line):
        ...
        score = int(cols[2])
        aliases = cols[3:]
        return aaqu_entity_linker.KBEntity(name, mid, score, aliases)
